        ...
        <div className="mx-auto max-w-[960px] px-8 py-8">
          ...
          <div className="mb-8">
            ...
            {rootFolders.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-neutral-200 bg-white py-12">
                <FolderClosed className="mb-3 h-6 w-6 text-neutral-300" />
                <p className="text-[13px] font-medium text-neutral-500">No folders yet</p>
          ...
          <div>
            ...
            {recentHighlights.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-neutral-200 bg-white py-12">
                <Highlighter className="mb-3 h-6 w-6 text-neutral-300" />
                <p className="text-[13px] font-medium text-neutral-500">No highlights yet</p>
                <p className="mt-1 text-[12px] text-neutral-400">
