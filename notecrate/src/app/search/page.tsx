...
import { searchHighlights, highlights as allHighlights, HIGHLIGHT_COLORS, type HighlightColor } from "@/lib/data";
...
export default function SearchPage() {
  ...
  const searchResults = query.length > 0 ? searchHighlights(query) : allHighlights;
  const filteredResults =
    activeColors.size > 0
      ? searchResults.filter((h) => activeColors.has(h.color))
      : searchResults;
